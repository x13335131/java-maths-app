 ...
 * @author x13335131
 */
public class LCOrdQs8GUI extends javax.swing.JFrame {

    /**
     * Creates new form LCOrdQs8
     */
    public LCOrdQs8GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("A deli sells 75 lunches\nin one day. Ten of \nthese lunches are\nvegetarian. What is the\nrelative frequency\nof selling a non-\nvegetarian lunch? \n(correct to two decimal\nplaces)\n");
        jTextArea1.setBorder(null);
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 90, 190, 200));

        answerTf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 330, 140, 30));
        ...
        jPanel1.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 360, 80, -1));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       LeavingCertOrdinaryControl.updateAns(ans, 7);
       LeavingCertOrdinaryControl.validateQuestion8();
       LCOrdQs9GUI LCOrdQ9 = new LCOrdQs9GUI();
       LCOrdQ9.setVisible(true);
       dispose();
