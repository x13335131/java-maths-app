 ...
 * @author x13335131
 */
public class LCOrdQs3GUI extends javax.swing.JFrame {

    /**
     * Creates new form LCOrdQs3
     */
    public LCOrdQs3GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("A card is drawn at\nrandom from a \nstandard pack of 52\ncards. What is the \nprobability that the \ncard drawn is a Jack?\n");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, 180, 140));

        answerTf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 300, 110, 30));
        ...
        jPanel1.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 330, 70, -1));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       LeavingCertOrdinaryControl.updateAns(ans, 2);
       LeavingCertOrdinaryControl.validateQuestion3();
       LCOrdQs4GUI LCOrdQ4 = new LCOrdQs4GUI();
       LCOrdQ4.setVisible(true);
       dispose();
