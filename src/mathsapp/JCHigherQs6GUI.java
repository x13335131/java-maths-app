 ...
 * @author x13335131
 */
public class JCHigherQs6GUI extends javax.swing.JFrame {

    /**
     * Creates new form JCHigherQs6
     */
    public JCHigherQs6GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("The lengths of two \npieces of timber are in \na ratio of 5 : 2. \nThe larger piece \nmeasures 250 mm. \nFind the length of the \nshorter piece. ");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, 190, 160));

        answerTf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 310, 150, 30));
        ...
        jPanel1.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 340, 70, -1));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       JuniorCertHigherControl.updateAns(ans, 5);
       JuniorCertHigherControl.validateQuestion6();
       JCHigherQs7GUI JCHQ7 = new JCHigherQs7GUI();
       JCHQ7.setVisible(true);
       dispose();
