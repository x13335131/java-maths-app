 ...
 * @author x14428818
 */
public class Construction6 extends javax.swing.JFrame {
    ConstructionApp MP;

    /**
     * Creates new form Construction6
     */
    ...
    private void PlayMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PlayMouseReleased
        File file = new File("Construction6.mp3");
        MP.Play("Construction6.mp3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Construction6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Construction6().setVisible(true);
            }
        });
    }
