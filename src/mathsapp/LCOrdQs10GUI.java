 ...
 * @author x13335131
 */
public class LCOrdQs10GUI extends javax.swing.JFrame {

    /**
     * Creates new form LCOrdQs10
     */
    public LCOrdQs10GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("The circumfrance of\na circle is 22π mm.\nFind the length of \nthe radius of the \ncircle.");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, -1, 140));

        radiusLbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        radiusLbl.setText("R=");
        jPanel1.add(radiusLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 310, 30, 30));
        ...
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 310, 90, 30));
        ...
        jPanel1.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 340, 80, -1));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       LeavingCertOrdinaryControl.updateAns(ans, 9);
       LeavingCertOrdinaryControl.validateQuestion10();
       LCOrdinarySummaryGUI fin = new LCOrdinarySummaryGUI();
       fin.setVisible(true);
       dispose();
