 ...
 * @author x13335131
 */
public class JCOrdQs5GUI extends javax.swing.JFrame {

    /**
     * Creates new form JCOrdQs5
     */
    public JCOrdQs5GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("The population of a town\nin the year 2000 was\n4850. \nThe population of the \nsame town in 2010 was \n5917. \nWhat was the percentage \nincrease in the \npopulation from 2000 to \n2010?");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, 200, 210));
        ...
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 340, 140, 30));

        backBtn.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        backBtn.setText("next");
        backBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                backBtnActionPerformed(evt);
            }
        });
        jPanel1.add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 410, 90, 30));
        ...
        jPanel1.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 370, 80, -1));
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
       ...
       JuniorCertOrdinaryControl.updateAns(ans, 4);
       JuniorCertOrdinaryControl.validateQuestion5();
       JCOrdQs6GUI JCOrdQ6 = new JCOrdQs6GUI();
       JCOrdQ6.setVisible(true);
       dispose();
