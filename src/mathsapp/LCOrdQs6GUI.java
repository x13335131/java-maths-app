 ...
 * @author x13335131
 */
public class LCOrdQs6GUI extends javax.swing.JFrame {

    /**
     * Creates new form LCOrdQs6
     */
    public LCOrdQs6GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("In how many different\nways can the letters\nof the word piglet be\narranged if the \narrangements must \nbegin with a vowel.");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 111, 180, 140));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       LeavingCertOrdinaryControl.updateAns(ans, 5);
       LeavingCertOrdinaryControl.validateQuestion6();
       LCOrdQs7GUI LCOrdQ7 = new LCOrdQs7GUI();
       LCOrdQ7.setVisible(true);
       dispose();
