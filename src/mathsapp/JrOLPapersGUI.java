 ...
 *
 */
public class JrOLPapersGUI extends javax.swing.JFrame {

    /**
     * Creates new form Year
     */
    public JrOLPapersGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        title2Lbl.setForeground(new java.awt.Color(153, 116, 30));
        title2Lbl.setText("Ordinary Level");
        getContentPane().add(title2Lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 140, 30));
    ...
    private void selectCombo1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_selectCombo1ItemStateChanged
        ...
        if (selectCombo1.getSelectedIndex() == 1) {
            try {
                if ((new File("JCOLP12011.pdf")).exists()) {
                    Process p = Runtime
                            .getRuntime()
                            .exec("rundll32 url.dll,FileProtocolHandler JCOLP12011.pdf");
                    p.waitFor();
                } else {
        ...
        if (selectCombo1.getSelectedIndex() == 2) {
            try {
                Desktop.getDesktop().browse(new URL("http://examinations.ie/archive/exampapers/2011/JC003GLP200EV.pdf").toURI());
            } catch (Exception e) {
            }
        }
        if (selectCombo1.getSelectedIndex() == 3) {
            try {
                Desktop.getDesktop().browse(new URL("http://examinations.ie/archive/exampapers/2012/JC003GLP100EV.pdf").toURI());
            } catch (Exception e) {
            }
        }
        if (selectCombo1.getSelectedIndex() == 4) {
            try {
                Desktop.getDesktop().browse(new URL("http://examinations.ie/archive/exampapers/2012/JC003GLP200EV.pdf").toURI());
            } catch (Exception e) {
            }
        }
        if (selectCombo1.getSelectedIndex() == 5) {
            try {
                Desktop.getDesktop().browse(new URL("http://www.examinations.ie/archive/exampapers/2013/JC003GLP100EV.pdf").toURI());
            } catch (Exception e) {
            }
        }
        if (selectCombo1.getSelectedIndex() == 6) {
            try {
                Desktop.getDesktop().browse(new URL("http://www.examinations.ie/archive/exampapers/2013/JC003GLP200EV.pdf").toURI());
            } catch (Exception e) {
            }
        }
