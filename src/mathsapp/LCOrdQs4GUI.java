 ...
 * @author x13335131
 */
public class LCOrdQs4GUI extends javax.swing.JFrame {

    /**
     * Creates new form LCOrdQs4
     */
    public LCOrdQs4GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("solve for x:\n2(4-3x)+12=7x–5(2x-7)");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, 180, 60));
        ...
        xLbl.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        xLbl.setText("x=");
        jPanel1.add(xLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 327, 30, 30));
        ...
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 330, 130, 30));
        ...
        jPanel1.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 360, 70, -1));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       LeavingCertOrdinaryControl.updateAns(ans, 3);
       LeavingCertOrdinaryControl.validateQuestion4();
       LCOrdQs5GUI LCOrdQ5 = new LCOrdQs5GUI();
       LCOrdQ5.setVisible(true);
       dispose();
