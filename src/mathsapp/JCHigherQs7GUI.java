 ...
 * @author x13335131
 */
public class JCHigherQs7GUI extends javax.swing.JFrame {

    /**
     * Creates new form JCHigherQs7
     */
    public JCHigherQs7GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("3x – [5 – (x – 3 )] = 6 \n");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, 200, 50));

        answerTf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 340, 140, 30));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       JuniorCertHigherControl.updateAns(ans, 6);
       JuniorCertHigherControl.validateQuestion7();
       JCHigherQs8GUI JCHQ8 = new JCHigherQs8GUI();
       JCHQ8.setVisible(true);
       dispose();
