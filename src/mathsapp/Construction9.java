 ...
 * @author x14428818
 */
public class Construction9 extends javax.swing.JFrame {

    ConstructionApp MP;

    /**
     * Creates new form Construction9
     */
    public Construction9() {
    ...
    private void PlayMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PlayMouseReleased
        File file = new File("Construction9.mp3");
        MP.Play("Construction9.mp3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Construction9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Construction9().setVisible(true);
            }
        });
    }
