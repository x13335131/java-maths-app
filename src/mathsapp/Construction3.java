 ...
 * @author x14428818
 */
public class Construction3 extends javax.swing.JFrame {

    ConstructionApp MP;

    /**
     * Creates new form Construction3
     */
    ...
    private void PlayMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PlayMouseReleased
        File file = new File("Construction3.mp3");
        MP.Play("Construction3.mp3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Construction3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Construction3().setVisible(true);
            }
        });
    }
