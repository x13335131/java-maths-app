 ...
 * @author x14428818
 */
public class Construction4 extends javax.swing.JFrame {

    ConstructionApp MP;

    /**
     * Creates new form Construction4
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(Play, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 170, 140, 70));
        ...
        Back1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mathsapp/back.png"))); // NOI18N
        Back1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Back1ActionPerformed(evt);
            }
        });
        getContentPane().add(Back1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 430, 40, 40));
    ...
    private void PlayMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PlayMouseReleased
        File file = new File("Construction4.mp3");
        MP.Play("Construction4.mp3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Construction4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Construction4().setVisible(true);
            }
        });
    }
