 ...
 * @author x14428818
 */
public class Construction12 extends javax.swing.JFrame {
    ConstructionApp MP;

    /**
     * Creates new form Construction12
     */
    public Construction12() {
    ...
    private void PlayMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PlayMouseReleased
        File file = new File("Construction12.mp3");
        MP.Play("Construction12.mp3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Construction12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Construction12().setVisible(true);
            }
        });
    }
