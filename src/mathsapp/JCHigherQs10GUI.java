 ...
 * @author x13335131
 */
public class JCHigherQs10GUI extends javax.swing.JFrame {

    /**
     * Creates new form JCHigherQs10
     */
    public JCHigherQs10GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Calculate the ratio of \nthe volume of the smaller\ncylinder to the volume of\nthe larger cylinder.");
        question.setViewportView(jTextArea1);

        getContentPane().add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, 210, 130));

        qsPicLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mathsapp/q9JC.PNG"))); // NOI18N
        qsPicLbl.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        getContentPane().add(qsPicLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 210, 180, 130));

        answerTf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        getContentPane().add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, 170, 30));
        ...
        getContentPane().add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 380, 70, -1));
        ...
        getContentPane().add(nextBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 410, 90, 30));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       JuniorCertHigherControl.updateAns(ans, 9);
       JuniorCertHigherControl.validateQuestion10();
       JCHigherSummaryGUI fin = new JCHigherSummaryGUI();
       fin.setVisible(true);
       dispose();
