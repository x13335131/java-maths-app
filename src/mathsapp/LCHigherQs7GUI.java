 ...
 * @author x13335131
 */
public class LCHigherQs7GUI extends javax.swing.JFrame {

    /**
     * Creates new form LCHigherQs7
     */
    public LCHigherQs7GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("A company budgets to\nmanufacture 5,000 \nunits of its product. \nMaterials required \nare 50kg per unit at\n€0.50 per kg. Each \nunit produced \nrequires six hours of\ndirect labour at €7 \nper hour. \nIndirect costs are\n€15,000. First \ncalculate(i)the cost\nof the 5,000 units.\nThen, using your \nanswer from\npart(i) calculate(ii)\nthe unit cost of \nmanufacture.");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 30, 190, 280));

        answerTf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 350, 180, 30));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       LeavingCertHigherControl.updateAns(ans, 6);
       LeavingCertHigherControl.validateQuestion7();
       LCHigherQs8GUI LCHQ8 = new LCHigherQs8GUI();
       LCHQ8.setVisible(true);
       dispose();
