 ...
 * @author x14428818
 */
public class Construction10 extends javax.swing.JFrame {
    ConstructionApp MP;

    /**
     * Creates new form Construction10
     */
    public Construction10() {
    ...
    private void PlayMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PlayMouseReleased
        File file = new File("Construction10.mp3");
        MP.Play("Construction10.mp3");
    ...
    private void BackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackActionPerformed
        ConLC1 myConLC1 = new ConLC1();
        myConLC1.setVisible(true);
        dispose();
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Construction10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Construction10().setVisible(true);
            }
        });
    }
