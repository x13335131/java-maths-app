 ...
 * @author x13335131
 */
public class LCOrdQs9GUI extends javax.swing.JFrame {

    /**
     * Creates new form LCOrdQs9
     */
    public LCOrdQs9GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Calculate the mean of\nset A{8,8,9,11,14}\n");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 150, 190, -1));
        ...
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 330, 130, 30));
        ...
        jPanel1.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 360, 80, -1));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
       ...
       LeavingCertOrdinaryControl.updateAns(ans, 8);
       LeavingCertOrdinaryControl.validateQuestion9();
       LCOrdQs10GUI LCOrdQ10 = new LCOrdQs10GUI();
       LCOrdQ10.setVisible(true);
       dispose();
