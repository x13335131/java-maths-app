 ...
 * @author x13335131
 */
public class JCHigherQs9GUI extends javax.swing.JFrame {

    /**
     * Creates new form JCHigherQs9
     */
    public JCHigherQs9GUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("The dimensions of two\nsolid cylinders are \nshown in the diagrams\nbelow. Calculate the \nratio of the curved \nsurface area of the \nsmaller cylinder\nto the curved surface \narea of the larger \ncylinder.");
        question.setViewportView(jTextArea1);

        jPanel1.add(question, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 180, 170));

        qsPicLbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/mathsapp/q9JC.PNG"))); // NOI18N
        jPanel1.add(qsPicLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 220, 200, 120));

        answerTf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jPanel1.add(answerTf, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, 160, 30));
        ...
        jPanel1.add(clearBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 380, 80, -1));
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
      String ans = answerTf.getText();
       JuniorCertHigherControl.updateAns(ans, 8);
       JuniorCertHigherControl.validateQuestion9();
       JCHigherQs10GUI JCHQ10 = new JCHigherQs10GUI();
       JCHQ10.setVisible(true);
       dispose();
